...
public class BlockPanel extends JPanel {
    ...
    public BlockPanel(Block block) {
        ...
        try (InputStream inputStream = this.getClass().getResourceAsStream(file)) {
            ...
            imageComponents.add(new ImageComponent(reader.readLine(), reader.readLine(),true));
            for(int i=1;i<n;i++) {
                imageComponents.add(new ImageComponent(reader.readLine(),reader.readLine()));
            }
            ...
            for(int i=0;i<n;i++){
                ...
                System.out.println(connectionType+" "+x+" "+y+" "+xLoc+" "+yLoc);
                ...
                if (!snapped){
                    ...
                    for(Component component :getParent().getComponents()){
                        ...
                        if(component instanceof BlockPanel blockPanel){
                            System.out.println(blockPanel.block.getBlockName());
                            ...
                            for(int i=0;i<outSnapPoints.size();i++){
                                System.out.println((inType==1?"vertical":"horizontal") + " " + blockPanel.block.getBlockName());
                                Point outSnapPoint = outSnapPoints.get(i);
                                System.out.println(outSnapPoint);
                                System.out.println(inSnapPoint);
                                System.out.println(outSnapPoint.distance(inSnapPoint));
